...
MYCREDS_FILE = "creds_watson_visual.json"
creds = json.load(open(MYCREDS_FILE))
...
for fname in glob(join(PICS_DIR, '*.jpeg')):
    # print("Testing", fname)
    ...
    if resp.status_code == 200:
        ...
        print("Error code was", resp.status_code, " -- not: 400")
